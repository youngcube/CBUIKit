...
@interface MJRefreshComponent : NSObject
...
#pragma mark - UIViewController Like
@class UIScrollView;
...
@interface UITableViewCell : NSTableCellView
...
@property (nonatomic, readonly, strong, nullable) NSImageView *imageView;   // default is nil.  image view will be created if necessary.

@property (nonatomic, readonly, strong, nullable) UILabel *textLabel;   // default is nil.  label will be created if necessary.
@property (nonatomic, readonly, strong, nullable) UILabel *detailTextLabel; // default is nil.  label will be created if necessary (and the current style supports a detail label).
...
@property (nonatomic, strong, nullable) NSView       *accessoryView;              // if set, use custom view. ignore accessoryType. tracks if enabled can calls accessory action
...
@property (nonatomic) NSEdgeInsets                    separatorInset; // allows customization of the separator frame
...
@property (nonatomic, copy, nullable) NSColor *backgroundColor; // default background color is dependent on style

@end

@interface UITableViewHeaderFooterView : NSView

- (instancetype)initWithReuseIdentifier:(nullable NSString *)reuseIdentifier;
- (nullable instancetype)initWithCoder:(NSCoder *)aDecoder;

@property (nonatomic, strong, null_resettable) NSColor *tintColor;
...
- (nullable NSArray<UITableViewRowAction *> *)tableView:(UITableView *)tableView editActionsForRowAtIndexPath:(NSIndexPath *)indexPath; // supercedes -tableView:titleForDeleteConfirmationButtonForRowAtIndexPath: if return value is non-nil
...
@property (nonatomic, strong) NSOutlineView *inner_outlineView;
...
@property (nonatomic) NSEdgeInsets separatorInset; // allows customization of the frame of cell separators

@property (nonatomic, strong, nullable) UIView *backgroundView; // the background view will be automatically resized to track the size of the table view.  this will be placed as a subview of the table view behind all cells and headers/footers.  default may be non-nil for some devices.
...
@property (nonatomic, strong, nullable) NSColor *sectionIndexColor;                   // color used for text of the section index
@property (nonatomic, strong, nullable) NSColor *sectionIndexBackgroundColor;         // the background color of the section index while not being touched
@property (nonatomic, strong, nullable) NSColor *sectionIndexTrackingBackgroundColor; // the background color of the section index while it is being touched
...
@property (nonatomic, readonly, nullable) NSArray<NSIndexPath *> *indexPathsForSelectedRows; // returns nil or a set of index paths representing the sections and rows of the selection.
...
@interface UIRefreshControl : NSControl
...
@property (null_resettable, nonatomic, strong) NSColor *tintColor;
...
@property (nonatomic, strong, null_resettable) IBOutlet UITableView *tableView;
